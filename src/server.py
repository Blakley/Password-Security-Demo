...
# server log function
def logs():
    # create page get requests logger (logs to terminal)
    ...
    # create login post requests logger (logs to a file)
...
def log_filter(record):
    # dont log post requests in terminal output
...
# create random passwords for login credentials
...
def validate(username, password, form_number):
    ...
    # look up credentials
    if form_number in valid_credentials:
        expected_username, expected_password = valid_credentials[form_number]
